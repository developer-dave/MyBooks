...
import io.bascom.service.RatingService;
...
class RatingController {
    ...
    @GetMapping(value = "/ratings/{name}/books", produces = JSON_UTF8)
    public ResponseEntity<String> getBooksByRating
        ...
        final BookFilter filter = new BookFilter()
                ...
                .addSort(sort)
                .addLimit(limit);
        final List<Book> books = ratingService.getBooks(filter);
